...
import RedEnvelopes from './RedEnvelopes/index.js';
import './index.css';
...
const commandcomponents = {Numeral,Notify,Toast,Loading,RedEnvelopes};
...
export {Dialog,Cell,Empty,Tag,CountUp,Ellipsis,Actionsheet,Switch,Evaluate,Rate,NavBar,Tabbar,TabbarItem,Numeral,Notify,Toast,Loading,Swipe,SwipeItem,Search,RedEnvelopes};
export default {
